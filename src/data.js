export default {
  ...
  about: [
    ...
    'Having worked end-to-end on many large projects I am comfortable taking on all of the above alongside other responsibilities, such as designing databases (MySQL / NoSQL), writing CI build scripts (Bash / Webpack / Gulp / Grunt), architecting API’s (Express / AWS Heroku / PHP) and keeping fine grain version control of codebases using Git.',
