export default {
  ...
  about: [
    'As a software engineer, I have many years of commercial experience in building robust and scalable websites / webapps and REST API’s.',
    ...
    'A keen advocate of PWA’s, I conform to development best practices (e.g. responsive design, cross browser development) whilst retaining solid commercial experience of Cordova and App store deployment.',
    'Having worked end-to-end on many large projects I am comfortable taking on all of the above alongside other responsibilities, such as writing CI build scripts (Bash / Webpack / Gulp / Grunt), designing databases (MySQL / NoSQL), architecting API’s (Node / AWS Heroku / PHP), keeping fine grain version control (Git) of codebases on the command line and working in multiple environments (Linux, OSX and Windows)',
    ...
    'My work history (which also includes music and guitar teaching) has enabled me to effectively mentor junior developers and has given me a lifelong appreciation for teamwork, as well as the ability to be effective both solo and remotely.',
  ]
}
